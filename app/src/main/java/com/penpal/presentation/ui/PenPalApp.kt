...
sealed class Screen(val route: String) {
    ...
    data object Transcribe : Screen("transcribe/{recordingId}") {
        fun createRoute(recordingId: String) = "transcribe/$recordingId"
    }
...
fun PenPalApp() {
    ...
    NavHost(
        ...
        composable(Screen.Recording.route) { backStackEntry ->
